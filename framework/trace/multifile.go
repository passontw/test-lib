...
// filesLogWriter will write logs to the file in json configuration  and write the same level trace to correspond file
// means if the file name in configuration is project.trace filesLogWriter will create project.error.trace/project.debug.trace
// and write the error-level logs to project.error.trace and write the debug-level logs to project.debug.trace
